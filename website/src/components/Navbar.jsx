    ...
    return (
        <>
            <div className='relative bg-[#f7fdfd] z-50'>
                    ...
                    <div className='hidden lg:block'>
                        {!user?.token ? (
                            <Link to='/user-auth'>
                                ...
                                px-5 focus:outline-none hover:bg-blue-700
                                hover:text-white rounded-full text-base border
                                border-blue-600" />
                            </Link>
                        ) : (
                            <div>
                ...
                <div className={`${isOpen ? "absolute flex bg-[#f7fdfd]"
                    : "hidden"
                    } container mx-auto lg:hidden flex-col pl-8 gap-3 py-8`}>
